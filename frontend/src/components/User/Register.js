		...
		<div className="row wrapper">
			<div className="col-10 col-lg-5">
				<form className="shadow-lg" encType='multipart/form-data' onSubmit={submitHandler}>
					...
					<div className="mb-3">
            <label className="form-label" htmlFor="email_field">Name</label>
            <input type="name" id="name_field" className="form-control" name="name" value={name} onChange={onChange} />
					...
					<div className="form-group mb-3">
						<label className="form-label" htmlFor='avatar_upload'>Avatar</label>
						<div className="d-flex align-items-center">
							...
							<div className="input-group me-0 mb-3">
